// Agents/RAG Teacher — a SEPARATE specialist teacher agent (one file, one subject; user design:
...
import { REGISTER as OWN_REGISTER } from '../registers/agents_rag.js';



export const DOMAIN = 'agents_rag';
