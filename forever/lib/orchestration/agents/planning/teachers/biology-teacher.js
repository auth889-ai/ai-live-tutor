// Biology Teacher — a SEPARATE specialist teacher agent (one file, one subject; user design:
...
import { REGISTER as OWN_REGISTER } from '../registers/biology.js';



export const DOMAIN = 'biology';
