// Chemistry Teacher — a SEPARATE specialist teacher agent (one file, one subject; user design:
...
import { REGISTER as OWN_REGISTER } from '../registers/chemistry.js';



export const DOMAIN = 'chemistry';
