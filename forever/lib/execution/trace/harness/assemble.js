...
export function buildTracedProgram({ constants = {}, trackerPy, code, entry, marker, resultLine, entryExample }) {
  ...
  return [
    ...
    '        self.right = right',
    'class Node:',
    '    def __init__(self, val=None, neighbors=None, children=None, next=None, random=None):',
    '        self.val = val',
    ...
    "for _cn in ('ListNode', 'TreeNode', 'Node'):",
    "    if _cn in _src and ('class ' + _cn) not in _src:",
    '        _ns[_cn] = globals()[_cn]',
    'exec(_compiled, _ns)',
    ...
    "if '_collops' in globals():",
    '    _payload["collops"] = _collops',
