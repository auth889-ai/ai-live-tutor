...
export async function POST(request) {
  ...
  if (body.tool === 'recursion' && selectRunner() === 'local') {
    return Response.json({ error: 'Recursion retrace needs the sandbox (set CODE_SANDBOX=docker or JUDGE0_URL)' }, { status: 503 });
  }
