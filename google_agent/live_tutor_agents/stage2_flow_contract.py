    ...
    packet: JsonDict = {
        ...
        "qualityContract": {
            **safe_dict(working.get("qualityContract")),
            "target": "world-class human tutor brain that later becomes a dynamic premium board lesson",
            "worldTeacherBrainContractV1": True,
            "mustUseSourceEvidence": True,
            "mustUseSelectedPageFullText": True,
            "mustUsePageImageAnalyses": True,
            "mustUseConceptExtraction": True,
            "mustUseKnowledgeGraph": True,
            "mustUseTeachingStrategy": True,
            "mustUseAnalogyExample": True,
            "mustPreserveSourceRefs": True,
            "mustCreateBoardReadyMicroSteps": True,
            "mustCreateTeacherPointingPlan": True,
            "mustCreateMistakeRepairPlan": True,
            "mustCreateExplainBackPrompt": True,
            "mustUseFullPdfSummaryAsBackground": True,
            "mustUseFullPdfOutlineAsBackground": True,
            "noRawPdfDump": True,
            "noBase64ImageBytes": True,
            "noParagraphOnlyLesson": True,
        ...
        "teacherBrainOutputContract": {
            ...
            "stepQuality": {
                ...
                "eachStepNeeds": [
                    ...
                    "teacherAction",
                    "sourceRefs",
                    "misconception or check when useful"
                ]
            },
            "agentCollaboration": {
                "sequentialSpine": [
                ...
                "parallelAfterStrategy": [
                    "AnalogyExampleAgent",
                    "DetailedExplanationAgent"
                ],
                "fusionRule": "DetailedExplanationAgent must synthesize sourceTruth + vision + conceptExtraction + knowledgeGraph + teachingStrategy + analogyExample into one board-ready teacher brain."
            }
        },
        "metadata": {
