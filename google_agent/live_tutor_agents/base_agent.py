    ...
    async def run(self, payload: JsonDict) -> AgentResult:
        ...
        try:
            ...
            return AgentResult(
                ...
                sourceRefs=safe_list(normalized.get("sourceRefs")),
                boardCommands=safe_list(normalized.get("boardCommands")),
                voiceScript=safe_list(normalized.get("voiceScript")),
                subtitles=safe_list(normalized.get("subtitles")),
                metadata={
                    "agentGroup": self.agent_group,
                    "realSeparateAgent": True,
                    "usesAdk": self.uses_adk,
